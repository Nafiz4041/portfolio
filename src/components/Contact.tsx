...
const CONTACT_EMAIL = 'mohaiminnafiz13@gmail.com';
...
const Contact = () => {
  ...
  const handleSubmit = () => {
    ...
    setStatus('✓ Your mail app is opening — just hit Send!');
    ...
    <div className="py-28 px-6 md:px-12 relative overflow-hidden">
      ...
      <div className="max-w-[860px] mx-auto">
        ...
        <div className="reveal text-center mb-12">
          ...
          <h2 className="text-5xl md:text-7xl font-bold tracking-tighter mb-4 leading-tight">
            Ready to scale?
          </h2>
        ...
        <div className="glass rounded-[2.5rem] p-1.5 border-white/10 reveal">
          <div className="bg-black/50 rounded-[2.2rem] p-8 md:p-12">
            <div className="grid md:grid-cols-2 gap-10 mb-10">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={item.label}>
                    <div className="text-[10px] text-blue-400 uppercase font-bold tracking-widest font-mono mb-1">
                      {item.label}
                    </div>
                    {item.href ? (
                ...
                {/* Social links */}
                <div>
                  <div className="text-[10px] text-blue-400 uppercase font-bold tracking-widest font-mono mb-3">
                    Connect With Me
                  </div>
                  <div className="flex flex-wrap gap-3">
                    {socialLinks.map((s) => (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className={`flex items-center gap-2 px-4 py-2 glass rounded-xl text-sm font-medium text-white/60 transition-all ${s.color}`}
                      >
                        {s.icon}
                        {s.label}
                      </a>
              ...
              <div>
                ...
                />
                {status && (
                  <p className={`text-sm font-bold font-mono mb-3 ${statusColor}`}>{status}</p>
                )}
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-5 bg-white text-black font-bold rounded-2xl text-base hover:bg-blue-500 hover:text-white transition-all hover:shadow-lg hover:shadow-blue-600/30"
            >
